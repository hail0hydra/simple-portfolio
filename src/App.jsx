...
export default function Portfolio() {
    ...
    setOutput([
      {
        cmd: "",
        res: [
          "<span class='text-yellow-400'>Welcome to Avinash's Terminal Portfolio!</span>",
  ...
  const commands = {
    help: [
      "<span class='text-cyan-300'>Available commands:</span> about, experience, projects, skills, contact, cv, whoami, fastfetch, date, clear"
    ],
    about: [
    ...
    contact: [
      ...
      "<span class='text-blue-400'>GitHub: github.com/hail0hydra</span>",
      "<span class='text-blue-400'>LinkedIn: linkedin.com/in/avinash-sharma-me</span>"
    ],
    cv: ["<a class='text-blue-400 underline' href='/Avinash-Sharma-Resume.pdf' target='_blank'>Download CV</a>"],
    whoami: ["<span class='text-cyan-300 font-bold'>avinash@portfolio</span>"],
    fastfetch: [
      "<span class='text-cyan-300 font-bold'>Avinash Sharma | Cybersecurity Enthusiast | HackTheBox Top 1000</span>",
  ...
  const handleCommand = (e) => {
    ...
    let response = commands[cmdLower] || [`<span class='text-red-500'>Command not found: ${command}</span>`];
        ...
        <div className="flex flex-col h-full">
              ...
              <div key={idx}>
                {line.cmd && (
                  <p>
                    ...
                    <span className="text-cyan-300 font-bold">{line.cmd}</span>
                  </p>
                )}
          ...
          <form onSubmit={handleCommand} className="flex mt-2 items-center">
            ...
            <input
              ...
              className="flex-grow bg-black text-cyan-300 outline-none border-none caret-green-400"
              autoFocus
            />
